                          ...
                          ListTile(
                            ...
                            subtitle: Row(
                              children: [
                                ...
                                CustomSized(width: 0.015),
                                smallText(title:'Lvl  ${userData['tap_per_earn']['level']}',fontWeight: FontWeight.w200),
                                CustomSized(width: 0.015),
                                const Icon(Icons.circle,size:5,),
                                CustomSized(width: 0.015),
                          ...
                          ListTile(
                              ...
                              subtitle: Row(
                                children: [
                                  ...
                                  const Icon(Icons.circle,size:5,),
                                  CustomSized(width: 0.015),
                                  smallText(title:'Lvl  ${userData['hp']['level']}',fontWeight: FontWeight.w200),
                                  CustomSized(width: 0.015),
                                  const Icon(Icons.circle,size:5,),
                                  CustomSized(width: 0.015),
                          ...
                          ListTile(
                              ...
                              subtitle:Row(
                                children: [
                                  ...
                                  const Icon(Icons.circle,size:5,),
                                  CustomSized(width: 0.015),
                                  smallText(title:'Lvl  ${userData['coin_per_second']['level']}',fontWeight: FontWeight.w200),
                                  CustomSized(width: 0.015),
                                  const Icon(Icons.circle,size:5,),
                                  CustomSized(width: 0.015),
                          ...
                          ListTile(
                              ...
                              subtitle:Row(
                                children: [
                                  ...
                                  const Icon(Icons.circle,size:5,),
                                  CustomSized(width: 0.015),
                                  smallText(title:'Lvl ${userData['energies']['level']}',fontWeight: FontWeight.w200),
                                  CustomSized(width: 0.015),
